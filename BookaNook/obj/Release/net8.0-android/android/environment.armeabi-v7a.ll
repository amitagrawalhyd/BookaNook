...
@dso_cache = dso_local local_unnamed_addr global [498 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 156928735, ; hash 0x95a8adf, from name: BookaNook.ViewModels.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 220284924, ; hash 0xd2147fc, from name: BookaNook.Models.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 300928633, ; hash 0x11efce79, from name: libaot-BookaNook.Common.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 425174721, ; hash 0x1957a6c1, from name: libaot-BookaNook.Models
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BookaNook.Models.dll.so
		ptr null; void* handle (0x0)
	}, ; 47
	...
	%struct.DSOCacheEntry {
		i64 460131117, ; hash 0x1b6d0b2d, from name: BookaNook.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 538724262, ; hash 0x201c47a6, from name: libaot-BookaNook.Common
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BookaNook.Common.dll.so
		ptr null; void* handle (0x0)
	}, ; 59
	...
	%struct.DSOCacheEntry {
		i64 691160822, ; hash 0x293246f6, from name: aot-BookaNook.Common.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BookaNook.Common.dll.so
		ptr null; void* handle (0x0)
	}, ; 75
	...
	%struct.DSOCacheEntry {
		i64 765101831, ; hash 0x2d9a8707, from name: aot-BookaNook.Models
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BookaNook.Models.dll.so
		ptr null; void* handle (0x0)
	}, ; 81
	...
	%struct.DSOCacheEntry {
		i64 874116803, ; hash 0x3419f6c3, from name: aot-BookaNook.ViewModels
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BookaNook.ViewModels.dll.so
		ptr null; void* handle (0x0)
	}, ; 97
	...
	%struct.DSOCacheEntry {
		i64 940887137, ; hash 0x3814cc61, from name: libaot-BookaNook.ViewModels.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BookaNook.ViewModels.dll.so
		ptr null; void* handle (0x0)
	}, ; 105
	...
	%struct.DSOCacheEntry {
		i64 1065112215, ; hash 0x3f7c5297, from name: BookaNook.ViewModels
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BookaNook.ViewModels.dll.so
		ptr null; void* handle (0x0)
	}, ; 120
	...
	%struct.DSOCacheEntry {
		i64 1636665295, ; hash 0x618d87cf, from name: libaot-BookaNook.Models.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BookaNook.Models.dll.so
		ptr null; void* handle (0x0)
	}, ; 179
	...
	%struct.DSOCacheEntry {
		i64 1800377341, ; hash 0x6b4f93fd, from name: aot-BookaNook.Common
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BookaNook.Common.dll.so
		ptr null; void* handle (0x0)
	}, ; 199
	...
	%struct.DSOCacheEntry {
		i64 1866175050, ; hash 0x6f3b924a, from name: libaot-BookaNook.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-BookaNook.dll.so
		ptr null; void* handle (0x0)
	}, ; 207
	...
	%struct.DSOCacheEntry {
		i64 1903399042, ; hash 0x71739082, from name: aot-BookaNook.ViewModels.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BookaNook.ViewModels.dll.so
		ptr null; void* handle (0x0)
	}, ; 213
	...
	%struct.DSOCacheEntry {
		i64 2270739309, ; hash 0x8758bb6d, from name: aot-BookaNook.Models.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BookaNook.Models.dll.so
		ptr null; void* handle (0x0)
	}, ; 263
	...
	%struct.DSOCacheEntry {
		i64 2335963732, ; hash 0x8b3bfa54, from name: BookaNook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-BookaNook.dll.so
		ptr null; void* handle (0x0)
	}, ; 270
	...
	%struct.DSOCacheEntry {
		i64 2969965952, ; hash 0xb1061580, from name: BookaNook.Common
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BookaNook.Common.dll.so
		ptr null; void* handle (0x0)
	}, ; 352
	...
	%struct.DSOCacheEntry {
		i64 3223165560, ; hash 0xc01d9a78, from name: BookaNook.Models
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BookaNook.Models.dll.so
		ptr null; void* handle (0x0)
	}, ; 386
	...
	%struct.DSOCacheEntry {
		i64 3362243877, ; hash 0xc867c525, from name: aot-BookaNook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-BookaNook.dll.so
		ptr null; void* handle (0x0)
	}, ; 397
	...
	%struct.DSOCacheEntry {
		i64 3366262822, ; hash 0xc8a51826, from name: libaot-BookaNook.ViewModels
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BookaNook.ViewModels.dll.so
		ptr null; void* handle (0x0)
	}, ; 399
	...
	%struct.DSOCacheEntry {
		i64 3371708083, ; hash 0xc8f82eb3, from name: BookaNook.Common.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BookaNook.Common.dll.so
		ptr null; void* handle (0x0)
	}, ; 401
	...
	%struct.DSOCacheEntry {
		i64 3554595326, ; hash 0xd3ded1fe, from name: libaot-BookaNook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-BookaNook.dll.so
		ptr null; void* handle (0x0)
	}, ; 416
	...
	%struct.DSOCacheEntry {
		i64 3782839737, ; hash 0xe1798db9, from name: aot-BookaNook.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-BookaNook.dll.so
		ptr null; void* handle (0x0)
	}, ; 439
